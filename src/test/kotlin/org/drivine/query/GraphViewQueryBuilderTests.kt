...
class GraphViewQueryBuilderTests {
    ...
    fun `should use index 0 for single relationships inside nested GraphViews`() {
        ...
        val builder = GraphViewQueryBuilder.forView(ParentViewWithNestedList::class, CypherDialect.NEO4J_5.grammar())
        val query = builder.buildQuery()
    ...
    fun `should correctly project deeply nested GraphViews with their Root fragments`() {
        ...
        val builder = GraphViewQueryBuilder.forView(TopLevelWithNestedGraphViews::class, CypherDialect.NEO4J_5.grammar())
        val query = builder.buildQuery()
    ...
    fun `should handle lazy sorted public property pattern`() {
        ...
        val builder = GraphViewQueryBuilder.forView(IssueWithSortedAssignees::class, CypherDialect.NEO4J_5.grammar())
        val query = builder.buildQuery()
